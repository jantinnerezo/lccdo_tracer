                                    ...
                                    <tbody>
                                        <?php foreach($graduates as $graduate):?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="view_profile.php?graduate_id=<?php echo $graduate->graduate_id;?>" class="btn btn-outline-dark"><span class="oi oi-person"></span></a>
                                                <a href="#!" class="btn btn-outline-danger delete" data-toggle="modal" data-target="#confirmDeletion" data-id="<?php echo $graduate->graduate_id;?>" data-name="<?php echo $graduate->firstname . ' ' .$graduate->lastname ;?>"><span class="oi oi-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;?>
  ...
  <div class="modal-content">
    <form action="controller.php" method="POST">
        <div class="modal-body">
               <div class="row">
                    <div class="container">
                         <input type="hidden" id="graduate_id" name="graduate_id">
                            <h3 id="msg"></h3>
                    </div>
               </div>
        </div>
        ...
        <button type="submit" class="btn btn-success" name="delete_graduate">Yes</button>
        </div>
    </form>
  </div>
</div>
...
<script>
    ...
    $( ".delete" ).click(function() {
         ...
         $('#graduate_id').val($(this).data("id"));
         $('#msg').text("Are you sure want to remove " + $(this).data("name") + " ?");
